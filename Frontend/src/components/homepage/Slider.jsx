...
export default function SimpleSlider() {
  ...
  return (
    ...
    <Slider  {...settings}>
      ...
      <img className="rounded-t-md"  src="../../public/corsoal pics/2.jpg" alt="" />
      <div className="glass rounded-b-md text-center  font-bold">
      Platform 9 3/4: Gateway to Hogwarts Adventure Awaits
      </div>
      </div>
      <div>
      <img className="rounded-t-md"  src="../../public/corsoal pics/3.jpg" alt="" />
      ...
      <img className="rounded-t-md"  src="../../public/corsoal pics/4.jpg" alt="" />
      <div className="glass rounded-b-md text-center  font-bold">
      ...
      <img className="rounded-t-md"   src="../../public/corsoal pics/5.jpg" alt="" />
      <div className="glass rounded-b-md text-center  font-bold">
      ...
      <img className="rounded-t-md"  src="../../public/corsoal pics/6.jpg" alt="" />
      <div className="glass rounded-b-md text-center  font-bold">
